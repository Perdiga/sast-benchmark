...
if __name__ == "__main__":
    ...
    for runner in app_config.application.runners:
        logger.debug("Running %s",app_config.application.runners[runner].get('module_name'))
        # Dynamically import the class
        module = importlib.import_module(app_config.application.runners[runner].get('module_name'))
        runner_class = getattr(module, app_config.application.runners[runner].get('class_name'))
